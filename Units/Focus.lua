...
function UUF:CreateFocusFrame()
    ...
    local Portrait = UUF.DB.global.Focus.Portrait
    local Health = UUF.DB.global.Focus.Health
    local PowerBar = UUF.DB.global.Focus.PowerBar
    ...
    if Buffs.Enabled then
        ...
        self.unitBuffs.onlyShowFocus = Buffs.OnlyShowFocus
        self.unitBuffs["growth-x"] = Buffs.GrowthX
        self.unitBuffs["growth-y"] = Buffs.GrowthY
        self.unitBuffs.filter = "HELPFUL"
        self.unitBuffs.PostCreateButton = function(_, button) UUF:PostCreateButton(_, button, "Focus", "HELPFUL") end
    ...
    if Debuffs.Enabled then
        ...
        self.unitDebuffs.onlyShowFocus = Debuffs.OnlyShowFocus
        self.unitDebuffs["growth-x"] = Debuffs.GrowthX
        self.unitDebuffs["growth-y"] = Debuffs.GrowthY
        self.unitDebuffs.filter = "HARMFUL"
        self.unitDebuffs.PostCreateButton = function(_, button) UUF:PostCreateButton(_, button, "Focus", "HARMFUL") end
...
function UUF:SpawnFocusFrame()
    ...
    local Frame = UUF.DB.global.Focus.Frame
    UF:RegisterStyle("UUF_Focus", UUF.CreateFocusFrame)
