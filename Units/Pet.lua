...
function UUF:CreatePetFrame()
    ...
    local Portrait = UUF.DB.global.Pet.Portrait
    local Health = UUF.DB.global.Pet.Health
    local PowerBar = UUF.DB.global.Pet.PowerBar
    ...
    local TopLeftText = UUF.DB.global.Pet.Texts.AdditionalTexts.TopLeft
    local TopRightText = UUF.DB.global.Pet.Texts.AdditionalTexts.TopRight
    ...
    if Buffs.Enabled then
        ...
        self.unitBuffs.onlyShowPet = Buffs.OnlyShowPet
        self.unitBuffs["growth-x"] = Buffs.GrowthX
        self.unitBuffs["growth-y"] = Buffs.GrowthY
        self.unitBuffs.filter = "HELPFUL"
        self.unitBuffs.PostCreateButton = function(_, button) UUF:PostCreateButton(_, button, "Pet", "HELPFUL") end
    ...
    if Debuffs.Enabled then
        ...
        self.unitDebuffs.onlyShowPet = Debuffs.OnlyShowPet
        self.unitDebuffs["growth-x"] = Debuffs.GrowthX
        self.unitDebuffs["growth-y"] = Debuffs.GrowthY
        self.unitDebuffs.filter = "HARMFUL"
        self.unitDebuffs.PostCreateButton = function(_, button) UUF:PostCreateButton(_, button, "Pet", "HARMFUL") end
