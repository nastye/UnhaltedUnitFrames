...
function UUF:CreateTargetFrame()
    ...
    local Portrait = UUF.DB.global.Target.Portrait
    local Health = UUF.DB.global.Target.Health
    local PowerBar = UUF.DB.global.Target.PowerBar
    ...
    if Buffs.Enabled then
        ...
        self.unitBuffs.onlyShowTarget = Buffs.OnlyShowTarget
        self.unitBuffs["growth-x"] = Buffs.GrowthX
        self.unitBuffs["growth-y"] = Buffs.GrowthY
        self.unitBuffs.filter = "HELPFUL"
        self.unitBuffs.PostCreateButton = function(_, button) UUF:PostCreateButton(_, button, "Target", "HELPFUL") end
    ...
    if Debuffs.Enabled then
        ...
        self.unitDebuffs.onlyShowTarget = Debuffs.OnlyShowTarget
        self.unitDebuffs["growth-x"] = Debuffs.GrowthX
        self.unitDebuffs["growth-y"] = Debuffs.GrowthY
        self.unitDebuffs.filter = "HARMFUL"
        self.unitDebuffs.PostCreateButton = function(_, button) UUF:PostCreateButton(_, button, "Target", "HARMFUL") end
