...
function UUF:CreateTargetTargetFrame()
    ...
    local Portrait = UUF.DB.global.TargetTarget.Portrait
    local Health = UUF.DB.global.TargetTarget.Health
    local PowerBar = UUF.DB.global.TargetTarget.PowerBar
    ...
    local TopLeftText = UUF.DB.global.TargetTarget.Texts.AdditionalTexts.TopLeft
    local TopRightText = UUF.DB.global.TargetTarget.Texts.AdditionalTexts.TopRight
    ...
    if Buffs.Enabled then
        ...
        self.unitBuffs.onlyShowTargetTarget = Buffs.OnlyShowTargetTarget
        self.unitBuffs["growth-x"] = Buffs.GrowthX
        self.unitBuffs["growth-y"] = Buffs.GrowthY
        self.unitBuffs.filter = "HELPFUL"
        self.unitBuffs.PostCreateButton = function(_, button) UUF:PostCreateButton(_, button, "TargetTarget", "HELPFUL") end
    ...
    if Debuffs.Enabled then
        ...
        self.unitDebuffs.onlyShowTargetTarget = Debuffs.OnlyShowTargetTarget
        self.unitDebuffs["growth-x"] = Debuffs.GrowthX
        self.unitDebuffs["growth-y"] = Debuffs.GrowthY
        self.unitDebuffs.filter = "HARMFUL"
        self.unitDebuffs.PostCreateButton = function(_, button) UUF:PostCreateButton(_, button, "TargetTarget", "HARMFUL") end
...
function UUF:SpawnTargetTargetFrame()
    ...
    local Frame = UUF.DB.global.TargetTarget.Frame
    UF:RegisterStyle("UUF_TargetTarget", UUF.CreateTargetTargetFrame)
