...
function UUF:CreateBossFrame()
    ...
    if Buffs.Enabled then
        ...
        self.unitBuffs.onlyShowBoss = Buffs.OnlyShowBoss
        self.unitBuffs["growth-x"] = Buffs.GrowthX
        self.unitBuffs["growth-y"] = Buffs.GrowthY
        self.unitBuffs.filter = "HELPFUL"
        self.unitBuffs.PostCreateButton = function(_, button) UUF:PostCreateButton(_, button, "Boss", "HELPFUL") end
    ...
    if Debuffs.Enabled then
        ...
        self.unitDebuffs.onlyShowBoss = Debuffs.OnlyShowBoss
        self.unitDebuffs["growth-x"] = Debuffs.GrowthX
        self.unitDebuffs["growth-y"] = Debuffs.GrowthY
        self.unitDebuffs.filter = "HARMFUL"
        self.unitDebuffs.PostCreateButton = function(_, button) UUF:PostCreateButton(_, button, "Boss", "HARMFUL") end
...
function UUF:SpawnBossFrames()
    local Frame = UUF.DB.global.Boss.Frame
    UF:RegisterStyle("UUF_Boss", UUF.CreateBossFrame)
