...
function UUF:CreateGUI()
    ...
    local function DrawUnitContainer(UUFGUI_Container, Unit)
        ...
        local function DrawFrameContainer(UUFGUI_Container)
            ...
            PowerBarBackdropColourByType:SetRelativeWidth(0.5)
        ...
        local function DrawBuffsContainer(UUFGUI_Container)
            ...
            BuffCountXOffset:SetCallback("OnValueChanged", function(widget, event, value) Buffs.Count.XOffset = value UUF:UpdateFrames() end)
            ...
            BuffCountYOffset:SetCallback("OnValueChanged", function(widget, event, value) Buffs.Count.YOffset = value UUF:UpdateFrames() end)
            ...
            BuffCountFontSize:SetCallback("OnValueChanged", function(widget, event, value) Buffs.Count.FontSize = value UUF:UpdateFrames() end)
        ...
        local function DrawDebuffsContainer(UUFGUI_Container)
            ...
            DebuffCountXOffset:SetCallback("OnValueChanged", function(widget, event, value) Debuffs.Count.XOffset = value UUF:UpdateFrames() end)
            ...
            DebuffCountYOffset:SetCallback("OnValueChanged", function(widget, event, value) Debuffs.Count.YOffset = value UUF:UpdateFrames() end)
            ...
            DebuffCountFontSize:SetCallback("OnValueChanged", function(widget, event, value) Debuffs.Count.FontSize = value UUF:UpdateFrames() end)
